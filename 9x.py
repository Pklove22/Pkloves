...
def uax():
    ...
    ua = f'[FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBRV/{str(application_version_code)};FBPN/{str(fbs)};FBLC/en_GB;FBMF/Xiaomi;FBBD/Redmi;FBDV/'+str(random.choice(["M2101K7AG","M2003J15SC","M2004J19C","M2006C3LG","M2007J20CG","M2010J19CG","M2011K2C","M2012K11AG","M2101K7BG","M2101K9G","M2102J20SG","M2102K1G","M2003J15SC","MI MAX 2","AT&amp-T","Redmi Note 4", "Redmi 4X","Redmi Note 8 Pro","Redmi Note 5","Redmi Note 8T","Redmi 6A","Redmi 7A","MI PLAY","MI 8 Lite","Mi 9T","Mi A2 Lite"," Mi 9", "M2101K7AG"]))+';FBSV/'+str(random.randint(6,12))+';FBCA/armeabi-v7a:armeabi;FBDM/{density='+str(random.randint(2,3))+'.'+str(random.randint(2,5))+',width=1080,height='+str(random.randint(1400,1499))+'};'+'FB_FW/1;]'
    return ua
#__________________| FILE M1 UA |__________________#
def uax():
    ua = f"Dalvik/2.1.0 Linux; U; Android "+str(random.randrange(5,14))+"; "+str(random.choice(["V2134","Y15","PD1911F_EX","V2146","V2059","V2045A","V2023EA","V2054A","V2029_PK","V2029","1929","V2147","V2120","V2134","AT&amp;amp-T","Vivo Y15", "Vivo Y15a","Vivo Y15s","Vivo Y1s","Vivo Y20","Vivo Y31s","Vivo Y50t","Vivo Y54s","Vivo Y73","Vivo Z1 Pro","Vivo Z5x","Vivo Z5x", "Vivo V9 Pro"]))+" Build/QP1A."+str(random.randrange(111111,999999))+") [FBAN/FB4A;FBAV/"+str(random.randint(199,399))+".0.0."+str(random.randint(1,9))+"."+str(random.randint(99,199))+";FBBV/"+str(random.randint(111111111,999999999))+";FBDM/{density="+str(random.randint(2,3))+"."+str(random.randint(2,5))+",width=1080,height="+str(random.randint(1400,1499))+"};FBLC/"+str(random.choice(["cs_CZ","en_GB","en_US","lt_LT","pl_PL","id_ID","ru_RU","pt_PT","he_IL","hi_IN","nl_NL"," it_IT","en_IN","es_ES","en_PK"]))+";FBCR/"+str(random.choice(["Tele2You","Telenor","FASTWEB","Banglalink","Sprint","Jazz","Vodafone IN","Vi India","Tele2 LT","Jio 4G","EE","Oi","MtelBG","AT&amp;amp-T","Ufone","Azercell"]))+";FBMF/Vivo;FBBD/"+str(random.choice(["Vivo","Vivo","Vivo"]))+";FBPN/com.facebook.katana;FBDV/"+str(random.choice(["V2134","Y15","PD1911F_EX","V2146","V2059","V2045A","V2023EA","V2054A","V2029_PK","V2029","1929","V2147","V2120","V2134","AT&amp;amp-T","Vivo Y15", "Vivo Y15a","Vivo Y15s","Vivo Y1s","Vivo Y20","Vivo Y31s","Vivo Y50t","Vivo Y54s","Vivo Y73","Vivo Z1 Pro","Vivo Z5x","Vivo Z5x", "Vivo V9 Pro"]))+";FBSV/"+str(random.randint(9,12))+";FBOP/1;FBCA/arm64-v8a:;]"
...
def uax():
    ...
    uaxx = f'[FBAN/FB4A;FBAV/{str(fb_version)};FBBV/{str(fb_ver_code)};FBDM/'+'{density=2.5,width=1080,height=2400};'+f'FBLC/en_US;FBRV/{str(fb_ver_code)};FBCR/Ufone;FBMF/Huawei;FBBD/Huawei;FBPN/{str(fbs)};FBDV/STK-L21;FBSV/10;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
